/*
 * Copyright 2014-2015 Amazon.com, Inc. All rights reserved.
 *
...
static DEVICE_ATTR(soda_boost_ctrl_debug, S_IWUSR | S_IRUGO, soda_boost_ctrl_debug_show, soda_boost_ctrl_debug_store);
...
static DEVICE_ATTR(socbatt_subscribe_state, S_IRUGO, soda_socbatt_subscribe_state_show, NULL);
	...
	if (soda_batt_check_reqd) {
		...
		if (battery_skist) {
			...
			if (!strcmp(soda_metric_info.skist_dock.uniqueid, battery_unique_id)) {
				...
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Diff_time", 1, buff);
				snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.skist_dock.capacity - soda_metric_info.skist_undock.capacity);
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Diff_Capacity", 1, buff);
				snprintf(buff, LOG_BUFF_LENGTH, "%d", soda_metric_info.skist_dock.voltage - soda_metric_info.skist_undock.voltage);
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Diff_Volt", 1, buff);
			}
			...
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Docking_time", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.skist_dock.capacity);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Docking_Cap", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d mV", soda_metric_info.skist_dock.voltage);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist Docking_Volt", 1, buff);
		} else {
			...
			if (!strcmp(soda_metric_info.soda_dock.uniqueid, battery_unique_id)) {
				...
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Diff_time", 1, buff);
				snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.soda_dock.capacity - soda_metric_info.soda_undock.capacity);
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Diff_Capacity", 1, buff);
				snprintf(buff, LOG_BUFF_LENGTH, "%d", soda_metric_info.soda_dock.voltage - soda_metric_info.soda_undock.voltage);
				LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Diff_Volt", 1, buff);
			}
			...
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Docking_time", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.soda_dock.capacity);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Docking_Cap", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d mV", soda_metric_info.soda_dock.voltage);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda Docking_Volt", 1, buff);
		}
...
static void soda_led_monitor_handler(struct work_struct *work)
{
	...
	if (atomic_read(&soda_docked)) {
		if (wario_battery_capacity > BATT1_GREEN_LED_THRESHOLD && 
			soda_battery_capacity > BATT2_GREEN_LED_THRESHOLD) {
			soda_led_control(LED_AMBER_OFF);
			soda_led_control(LED_GREEN_ON);
		} else {
...
static void soda_init_dock_status (struct soda_drvdata *me,bool boot)
{
	...
	if (gpio_soda_dock_detect(me->sda_gpio)) {	
		...
		if (battery_skist) {
			...
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist UnDocking_time", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.skist_undock.capacity);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist UnDocking_Cap", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d mV", soda_metric_info.skist_undock.voltage);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Skist UnDocking_Volt", 1, buff);
		} else {
			...
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda UnDocking_time", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d %%", soda_metric_info.soda_undock.capacity);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda UnDocking_Cap", 1, buff);
			snprintf(buff, LOG_BUFF_LENGTH, "%d mV", soda_metric_info.soda_undock.voltage);
			LLOG_DEVICE_METRIC(DEVICE_METRIC_HIGH_PRIORITY, DEVICE_METRIC_TYPE_COUNTER, "kernel", "Soda_fg", "Soda UnDocking_Volt", 1, buff);
		}
